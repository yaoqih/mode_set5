...
if __name__ == '__main__':
    ...
    parser.add_argument('--model_id', type=str, required=False, default='stock_96_96', help='model id')
    parser.add_argument('--model', type=str, required=False, default='iTransformer',
                        help='model name, options: [iTransformer, iInformer, iReformer, iFlowformer, iFlashformer,PatchMixer,SegRNN]')
    parser.add_argument('--use_wandb', type=bool, required=False, default=True,
                        help='use wandb to upload data')
    ...
    parser.add_argument('--checkpoint_name', type=str, default='checkpoint', help='model checkpoint name')
    ...
    parser.add_argument('--huber_delta', type=float, default=0.05, help='delta in loss function')
    ...
    if args.is_training:
        for ii in range(args.itr):
            ...
            wandb.agent('v4rjl1z6', project='iTransformer_first_full',function=exp.train, count=15)
            # exp.train(setting)
