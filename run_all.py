...
if __name__ == '__main__':
    ...
    parser.add_argument('--model_id', type=str, required=False, default='stock_96_2', help='model id')
    ...
    parser.add_argument('--loss', type=str, default='final_rate_mse', help='loss function')
